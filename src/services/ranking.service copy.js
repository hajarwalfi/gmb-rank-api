...
export async function captureGoogleSearchLocalScreenshot({
  ...
  // - Google header + search bar = ~55px
  // - Navigation tabs (AI Mode, All, Maps...) = ~40px
  // - Filter bar (Online estimates, Open now, Top rated) = ~50px
  // - Total header = ~145px before first GMB card
