...
router.get('/gmb-review-monthly', GmbController.getGmbReviewMonthlySnapshot);
router.get('/gmb-review-monthly/client', GmbController.getGmbReviewMonthlyClientHistory);
router.post('/gmb-review-monthly/rebuild', (req, res, next) => {
  req.socket?.setTimeout?.(0);
  res.setTimeout?.(0);
  next();
}, GmbController.rebuildGmbReviewMonthlySnapshot);
